...
/* #endif */
    ...
    else if ((s->cur_file_info.compression_method==Z_DEFLATED) && (!raw))
    {
      ...
      err = ZLibImports::zlInflateInit2( &pfile_in_zip_read_info->stream, -MAX_WBITS );
      if (err == Z_OK)
...
#            endif
        ...
        if ((pfile_in_zip_read_info->compression_method==0) || (pfile_in_zip_read_info->raw))
        {
            ...
            pfile_in_zip_read_info->crc32 = ZLibImports::zlCrc32( pfile_in_zip_read_info->crc32, pfile_in_zip_read_info->stream.next_out, uDoCopy );
        ...
        else
        {
            ...
            if ((pfile_in_zip_read_info->rest_read_uncompressed ==
                ...
                flush = Z_FINISH;
            */
            err = ZLibImports::zlInflate( &pfile_in_zip_read_info->stream, flush );
            ...
            pfile_in_zip_read_info->crc32 = ZLibImports::zlCrc32( pfile_in_zip_read_info->crc32, bufBefore, ( uInt )( uOutThis ) );
...
int unzCloseCurrentFile (unzFile file)
{
    ...
    if (pfile_in_zip_read_info->stream_initialised == Z_DEFLATED)
        ZLibImports::zlInflateEnd( &pfile_in_zip_read_info->stream );
#ifdef HAVE_BZIP2
